...
public class OpenLabel extends Widget {
    ...
    protected @Null String ellipsis;
    
    public OpenLabel (@Null CharSequence text, Skin skin) {
        this(text, skin.get(Label.LabelStyle.class));
    }
    
    public OpenLabel (@Null CharSequence text, Skin skin, String styleName) {
     ...
     * color. */
    public OpenLabel (@Null CharSequence text, Skin skin, String fontName, Color color) {
     ...
     * skin. */
    public OpenLabel (@Null CharSequence text, Skin skin, String fontName, String colorName) {
        this(text, new Label.LabelStyle(skin.getFont(fontName), skin.getColor(colorName)));
    }
    
    public OpenLabel (@Null CharSequence text, Label.LabelStyle style) {
    ...
    private void computePrefSize () {
        ...
        GlyphLayout prefSizeLayout = OpenLabel.prefSizeLayout;
